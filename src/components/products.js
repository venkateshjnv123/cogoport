...
function Products() {
  const data1 = [
    ...
    array1 : ['Ocean: FCL','Ocean:LCL','International Air', 'Customs, CFS, & Handling']
    },
    { name : "Domestic Logistics",
    array1 : ['FTL, PTL','Trailer & Rail Container Haulage']
    },
    { name : "Supply Chain Solutions",
    array1 : ['CogoAssured','Domestic Fulfilment','Door to Door Shipments', 'Cargo Insurance']
    },
    { name : "Financial Services",
    array1 : ['Pay Later','Export Factoring']
    },
    { name : "Trade Management Solutions",
    array1 : ['Freight Rates & Schedules','Quick Premium Quotations','Duties & Taxes Calculator', 'Tracking & Visibility']
    },
    ]
  return (
    <div>
...
<a href="null">
                  <div className="card prodCard">
                    ...
                    <h6 className="prodMore">Find Out More<ArrowRightAltIcon sx={{width:'1em', height:'1em', color : '#ee3425'}}/> </h6>
                  </div>
                </a>
