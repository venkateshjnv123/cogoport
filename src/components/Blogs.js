        ...
        <div className="blogCardContainer">
          {data1.map((items) => (
            <div className="card blogCard">
              <a href="null">
                <img className="blogPic" src={items.image1} alt="Pic" />
                <div className="blogText">
                  <h4 className="blogText1">{items.head}</h4>
                  <h4 className="blogText2">{items.name} </h4>
                  <p className="blogText3">{items.des}</p>
                  <div className="blogEnd">
                    <span className="blogMore">
                      Read more{" "}
                      <ArrowRightAltIcon
                        sx={{ width: "1em", height: "1em", color: "#ee3425" }}
                      />
                    </span>
